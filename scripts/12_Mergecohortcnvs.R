...
#directorypatients <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/CNVs/Patients"
#outputcohort <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/CNVs/Cohort/SigProfiler/MatrixGenerator/Cohort.CNV48.matrix.tsv"
...
for (i in patients) {
  fulldirectory <- paste0(directorypatients, "/", i, "/SigProfiler/results/MatrixGenerator/", i, ".CNV48.matrix.tsv")
