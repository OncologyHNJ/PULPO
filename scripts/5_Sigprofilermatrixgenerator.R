...
#inputdata <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/SVs/Patients/Patient-53/SigProfiler/data/SigProfilerSVdf.bedpe"
#pythondirectory <- "/home/user/miniconda3/envs/PULPO/bin/python3.10"
#output <-  "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/SVs/Patients/Patient-53/SigProfiler/results/SVs/MatrixGenerator"
#patientid <- "Patient-53"
...
tryCatch({
  ...
  SigProfilerMatrixGeneratorR::SVMatrixGenerator(input_dir = dirpath, project = patientid, output_dir = output)
}, error = function(e) {
