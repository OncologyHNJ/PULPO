...
#inputdata <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/DATA/Patients/Patient-3/OGMdata/"
#output <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/CNVs/Patients/Patient-3/SigProfiler/data/SigProfilerCNVdf.tsv"
#patient <- "Patient-3"
