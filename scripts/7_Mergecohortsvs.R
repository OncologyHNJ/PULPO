...
#directorypatients <- "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/SVs/Patients"
#outputcohort <-  "/home/user/MARTA/LABO/PULPO/PULPOpruebadesde0/results/SVs/Cohort/Cohort.SV32.matrix.tsv"
