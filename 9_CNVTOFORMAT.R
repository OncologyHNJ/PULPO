...
patient <- args[3]
##################################################
#inputdata <-  "/home/user/MARTA/PULPO_ejecutadoprueba/results/Patient-113/OGMdata"
#output <- "/home/user/MARTA/PULPO_ejecutadoprueba/results/Patient-113/SigProfiler/data/SigProfilerCNVdf.tsv"
#patient <- "Patient-113"
##################################################
#inputdata <- paste0(inputdata,"/OGMdata")
pattern <- "CNV"
